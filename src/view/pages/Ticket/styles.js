...
import {ASPECT_RATIOS} from '../../../helpers/constants'

export default makeStyles(theme => {
  const calcRatio = ratio => {
    switch (ratio) {
      case 2:
        return ASPECT_RATIOS['2:1']
      case 5 / 3:
        return ASPECT_RATIOS['5:3']
      case 16 / 9:
        return ASPECT_RATIOS['16:9']
      default:
        return ASPECT_RATIOS['3:1']
    }
  }
  ...
  return {
    ...
    ticketImage: ratio => ({
      borderRadius: 8,
      width: calcRatio(ratio)?.width,
      height: calcRatio(ratio)?.height,
      resizeMode: 'contain',
    }),
    dateContainer: {
      marginTop: 8,
